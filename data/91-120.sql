...
(94, 1, 1, 89610, 'Heaney, Hayes and Durgan', 'Accepted'),
(94, 1, 2, 436995, 'Batz Group', 'Declined'),
(94, 2, 1, 72486, 'Stanton LLC', 'Accepted'),
(95, 1, 1, 153456, 'Berge and Sons', 'Accepted'),
(96, 1, 1, 55130, 'Turcotte Group', 'Declined'),
(96, 1, 2, 134083, 'Batz Group', 'Accepted'),
(97, 1, 1, 193039, 'Kuvalis-Erdman', 'Accepted'),
(97, 1, 2, 218568, 'Rowe-Armstrong', 'Declined'),
(97, 2, 1, 190551, 'Rowe-Armstrong', 'Accepted'),
(98, 1, 1, 187076, 'Heaney, Hayes and Durgan', 'Declined'),
(98, 1, 2, 299603, 'Kuvalis-Erdman', 'Accepted'),
(99, 1, 1, 70076, 'Kuvalis-Erdman', 'Declined'),
(99, 1, 2, 55225, 'Turcotte Group', 'Declined'),
(100, 1, 1, 209951, 'Herman, Romaguera and Simonis', 'Accepted'),
(101, 1, 1, 57920, 'Batz Group', 'Accepted'),
(102, 1, 1, 130690, 'Kuvalis-Erdman', 'Declined'),
(102, 1, 2, 470837, 'Stanton LLC', 'Accepted'),
(103, 1, 1, 70185, 'Heaney, Hayes and Durgan', 'Accepted'),
(103, 1, 2, 359987, 'Kuvalis-Erdman', 'Declined'),
(103, 2, 1, 50921, 'Heaney, Hayes and Durgan', 'Accepted'),
(103, 3, 1, 301410, 'Kuvalis-Erdman', 'Accepted'),
(104, 1, 1, 202235, 'Berge and Sons', 'Accepted'),
(104, 1, 2, 53140, 'Stanton LLC', 'Declined'),
(104, 1, 3, 199260, 'McDermott, Bashirian and Witting', 'Declined'),
(104, 1, 4, 61288, 'Schoen, Huel and Emard', 'Declined'),
(105, 1, 1, 128278, 'Heaney, Hayes and Durgan', 'Declined'),
(105, 1, 2, 274243, 'Batz Group', 'Declined'),
(105, 1, 3, 189603, 'Batz Group', 'Accepted'),
(105, 2, 1, 284115, 'Herman, Romaguera and Simonis', 'Declined'),
(105, 2, 2, 50038, 'Herman, Romaguera and Simonis', 'Accepted'),
(106, 1, 1, 63165, 'Rowe-Armstrong', 'Accepted'),
(107, 1, 1, 218143, 'Rowe-Armstrong', 'Accepted'),
(108, 1, 1, 57768, 'Berge and Sons', 'Accepted'),
(108, 1, 2, 159650, 'McDermott, Bashirian and Witting', 'Declined'),
(108, 1, 3, 185813, 'Turcotte Group', 'Declined'),
(109, 1, 1, 136792, 'Stanton LLC', 'Declined'),
(109, 1, 2, 219486, 'Heaney, Hayes and Durgan', 'Accepted'),
(110, 1, 1, 231937, 'Stanton LLC', 'Accepted'),
(110, 2, 1, 263064, 'Stanton LLC', 'Accepted'),
(111, 1, 1, 144287, 'Schoen, Huel and Emard', 'Accepted'),
(112, 1, 1, 386209, 'Stanton LLC', 'Accepted'),
(113, 1, 1, 56569, 'Rowe-Armstrong', 'Accepted'),
(114, 1, 1, 148392, 'Kuvalis-Erdman', 'Declined'),
(114, 1, 2, 209409, 'Schoen, Huel and Emard', 'Accepted'),
(115, 1, 1, 671610, 'Heaney, Hayes and Durgan', 'Declined'),
(115, 1, 2, 275722, 'Rowe-Armstrong', 'Accepted'),
(115, 1, 3, 183785, 'Turcotte Group', 'Declined'),
(115, 2, 1, 115078, 'Rowe-Armstrong', 'Accepted'),
(115, 3, 1, 71699, 'Rowe-Armstrong', 'Accepted'),
(116, 1, 1, 42534, 'McDermott, Bashirian and Witting', 'Accepted'),
(117, 1, 1, 57775, 'Berge and Sons', 'Accepted'),
(118, 1, 1, 107583, 'Herman, Romaguera and Simonis', 'Declined'),
(118, 1, 2, 243417, 'Schoen, Huel and Emard', 'Accepted'),
(119, 1, 1, 224778, 'Berge and Sons', 'Accepted'),
(120, 1, 1, 85616, 'Kuvalis-Erdman', 'Accepted'),
(120, 2, 1, 141083, 'Kuvalis-Erdman', 'Accepted'),
(120, 2, 2, 208945, 'Heaney, Hayes and Durgan', 'Declined');