...
VALUES
    ...
    (49,1,2,303,'2023-01-14','2023-01-19'),
...
VALUES  (31,1,2,"PCR","2013-02-17","12:46:00","positive",2),
        (31,1,3,"PCR","2002-09-29","12:00:00","positive",2)
        (32,1,1,"PCR","2019-01-12","23:00:00","positive",2),
        (33,3,1,"Mutasi EGFR","2019-09-21","13:11:00","negative",4),
        (34,2,1,"IGRA","2002-10-12","15:00:00","negative",1),
        (35,1,2,"BCR ABL","2015-03-24","11:00:00","positive",5),
        (36,1,2,"Rapid Test","2000-01-23","18:45:00","positive",2),
        (37,1,1,"Faktor VIII","2014-12-24","13:10:00","positive",9),
        (38,1,3,"CRP Kualitatif","2002-06-21","14:27:00","negative",5),
        (39,1,4,"Rapid Test","2010-04-02","11:10:00","negative",2),
        (40,2,5,"PCR","2015-10-28","12:46:00","positive",2),
        (41,1,2,"PCR","2018-05-23","12:00:00","positive",2)
        (42,2,2,"PCR","2013-02-28","23:00:00","positive",2),
        (43,1,1,"Mutasi EGFR","2012-11-12","13:11:00","negative",4),
        (44,3,1,"IGRA","2016-10-27","15:00:00","negative",1),
        (46,2,2,"BCR ABL","2004-10-05","11:00:00","positive",5),
        (47,1,3,"Rapid Test","2019-07-07","18:45:00","positive",2),
        (48,3,1,"Faktor VIII","2002-10-29","13:10:00","positive",9),
        (48,4,2,"CRP Kualitatif","2008-03-07","14:27:00","negative",5),
        (49,1,2,"Rapid Test","2016-07-05","11:10:00","negative",2);
        (51,1,2,"IGRA","2002-10-12","15:00:00","negative",1),
        (55,1,1,"BCR ABL","2015-03-24","11:00:00","positive",5),
        (56,2,6,"Rapid Test","2000-01-23","18:45:00","positive",2),
        (58,1,1,"Faktor VIII","2014-12-24","13:10:00","positive",9),
        (60,1,1,"CRP Kualitatif","2002-06-21","14:27:00","negative",5),

INSERT INTO prosedur
    (id_pasien, id_rekam_medis, id_aktivitas, jenis_prosedur, tanggal_prosedur, jam_prosedur)
VALUES
    (31,1,3, 'Persalinan normal', '2021-10-16', '22:30:00'),
    (33,1,1, 'Operasi kista', '2022-05-17', '09:30:00'),
    (33,2,1, 'Operasi batu ginjal', '2021-09-27', '03:00:00'),
    (33,2,3, 'Pengobatan jerawat', '2021-09-14', '13:30:00'),
    (33,3,3, 'Pengobatan jerawat', '2022-07-18', '14:00:00'),
    (36,1,2, 'Operasi tumor', '2022-05-22', '20:15:00'),
    (39,1,1, 'Tes darah', '2020-01-28', '18:00:00'),
    (40,1,1, 'Operasi jalan napas', '2021-04-23', '08:00:00'),
    (42,1,3, 'Terapi perilaku kognitif', '2022-08-26', '13:00:00'),
    (44,1,1, 'Pemeriksaan mental', '2022-05-06', '21:00:00'),
    (48,1,1, 'Pencabutan gigi', '2021-11-23', '08:00:00'),
    (49,1,2, 'Pengangkatan kutil kulit', '2022-04-08', '11:45:00'),
    (51,1,3, 'Pemeriksaan pendengaran', '2021-04-27', '20:00:00'),
    (54,1,1, 'Operasi jalan napas', '2020-10-08', '10:30:00'),
    (56,1,3, 'Pengobatan infertilitas', '2021-11-18', '18:00:00'),
    (56,2,4, 'Pengobatan farmakologis', '2023-02-22', '16:00:00'),
    (57,1,1, 'Pengobatan sakit jantung', '2022-03-14', '18:00:00'),
    (57,2,2, 'Persalinan normal', '2021-01-13', '17:00:00'),
    (59,1,2, 'Tes darah', '2022-11-14', '09:00:00'),
    (59,1,3, 'Pembersihan gigi', '2023-03-09', '09:30:00'),
